...
spatial resolution, conditions that a fixed, wide-angle views cannot
consistently provide.
Moreoever, we aim to provide growers with a system capable of branch-level
...
they can resolve the fine bark texture characteristic of cankers, but consequently 
have narrow fields of view.
...
symptoms, gathered across multiple collection sessions in orchards including 
Virginia and the greater Pittsburgh region.
